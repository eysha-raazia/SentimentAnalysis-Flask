...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\hp envy\PycharmProjects\MLOpsTasks\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\hp envy\PycharmProjects\MLOpsTasks\venv\Scripts\deactivate.nu'
